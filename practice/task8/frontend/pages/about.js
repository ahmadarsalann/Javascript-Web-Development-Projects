...
export default function About() {
	return (
		...
		<h4>Below you will find the videos that are amazing!</h4> 
		<style jsx>{`
			    h1 {
			    			font-weight: "bold";
			  ...
			  `}</style>
		<iframe width="400" height="300" src="https://www.youtube.com/embed/g2mLOVHZ2u4" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen="allowFullScreen"></iframe>
